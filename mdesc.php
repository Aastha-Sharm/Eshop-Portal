...
<html>
    ...
    echo "<div class='col-sm-2'><img src='$row1[4]' width='380px' height='280px'/></div>";
    echo "<div class='col-sm-1'></div>";
    echo "<div class='col-sm-5'>";
    echo "<div><div col-sm-12'><h3>$row1[1]</h3></div></div>";
    echo "<br>";
    echo "<div><div col-sm-12'>Price : $row1[2]</div></div>";
    echo "<div><div col-sm-12'>OS : $row2[1], Processor : $row2[2], RAM : $row2[9], Storage : $row2[8]</div></div>";
    echo "<div><div col-sm-12'>Color : $row2[3]</div></div>";
    echo "<div><div col-sm-12'>$row2[16]</div></div>";
    echo "<br>";
    echo "<div><div col-sm-12'><a class='btn btn-success' style='width:120px' href='mycart.php?pid=$row1[0]&type=$row1[3]'>Add To Cart</a></div></div>";
    echo "</div>";
    echo "</div>";
